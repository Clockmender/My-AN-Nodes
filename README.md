...
That new directory should contain an empty file named \__init\__.py - create this with any text editor or copy one from another AN directory. This can be downloaed from the top level directory as an option.
